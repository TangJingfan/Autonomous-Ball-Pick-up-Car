...
PLUGINLIB_EXPORT_CLASS(loose_abp_planner::LooseABPPlanner,
                       nav_core::BaseLocalPlanner)

namespace loose_abp_planner {
// constructor and destructor
LooseABPPlanner::LooseABPPlanner() { setlocale(LC_ALL, ""); }
LooseABPPlanner::~LooseABPPlanner() {}
...
void LooseABPPlanner::initialize(std::string name, tf2_ros::Buffer *tf,
...
bool LooseABPPlanner::computeVelocityCommands(geometry_msgs::Twist &cmd_vel) {
...
bool LooseABPPlanner::isGoalReached() { return goal_reached_; }
} // namespace loose_abp_planner
